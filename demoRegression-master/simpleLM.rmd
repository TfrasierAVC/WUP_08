...
## make a simple regression model age
...
```{r}
MONTHmodel<- lm(LENGTH~MONTH,data=bears)
plot(LENGTH~MONTH,data=bears)
abline(MONTHmodel)
summary.lm(MONTHmodel)
```

for all the models HEADLEN had the highest adjusted R Squared amongst the rest.